...
?>
    ...
    <section style="padding: 0 0 4rem 0;">
        <div class="container">
            <div class="reveal reveal-scale" style="background: var(--sandal-light); border: 2px solid var(--gold); border-radius: var(--radius-lg); padding: 3rem 2rem; text-align: center; box-shadow: var(--shadow-lg); position: relative; overflow: hidden;">
                ...
                <div style="display: inline-block; background: var(--white); border: 1px solid var(--sandal-border); padding: 0.6rem 1.75rem; border-radius: 50px; font-family: 'Montserrat', sans-serif; font-size: 0.9rem; font-weight: 700; text-transform: uppercase; letter-spacing: 0.12em; color: var(--sienna); box-shadow: var(--shadow-sm); margin-bottom: 2rem;">
                    NOT ANOTHER DIET, A BETTER WAY TO LIVE.
                </div>

                <!-- Innovative Online & Offline Consultation Interactive Switcher -->
                <div style="background: var(--white); border: 1px solid var(--gold); border-radius: var(--radius-md); padding: 1.5rem; max-width: 720px; margin: 0 auto; box-shadow: var(--shadow-md);">
    ...
    <section style="padding: 5rem 0; background: linear-gradient(180deg, var(--sandal-light) 0%, var(--white) 100%);">
        <div class="container">
            <div class="section-header center reveal">
            ...
            <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(320px, 1fr)); gap: 2.5rem; align-items: stretch;">
                ...
                <div class="reveal reveal-left" style="background: var(--sandal-light); border: 2px solid var(--gold); border-radius: var(--radius-lg); padding: 2.75rem 2rem; box-shadow: var(--shadow-lg); display: flex; flex-direction: column; justify-content: space-between; position: relative;">
                    <div>
                        ...
                        <div style="background: var(--white); border-radius: var(--radius-md); padding: 1.25rem; border: 1px solid var(--sandal-border); margin-bottom: 1.75rem;">
                            <ul style="list-style: none; display: flex; flex-direction: column; gap: 0.85rem; font-size: 0.9rem; color: var(--green-dark); font-weight: 600;">
                                <li style="display: flex; align-items: center; gap: 0.75rem;"><span style="color: var(--gold);">🌿</span> Certified Diabetes Educator</li>
                                <li style="display: flex; align-items: center; gap: 0.75rem;"><span style="color: var(--gold);">🌿</span> 7+ Years Experienced Nutritionist</li>
                        ...
                        <div style="background: rgba(66, 75, 46, 0.06); border-left: 4px solid var(--green-dark); padding: 1.25rem; border-radius: var(--radius-sm); margin-bottom: 1.75rem;">
                            <strong style="display: block; color: var(--green-dark); font-size: 0.95rem; margin-bottom: 0.5rem;">Core Philosophy:</strong>
                            <div style="font-size: 0.9rem; color: var(--green-dark); display: flex; flex-direction: column; gap: 0.4rem; font-weight: 600;">
                                <span>🛑 No crash diets.</span>
                                <span>🛑 No unrealistic restrictions.</span>
                ...
                <div class="reveal reveal-right" style="background: var(--white); border: 2px solid var(--gold-alt); border-radius: var(--radius-lg); padding: 2.75rem 2rem; box-shadow: var(--shadow-lg); display: flex; flex-direction: column; justify-content: space-between;">
                    <div>
                        <div style="text-align: center; margin-bottom: 1.5rem;">
